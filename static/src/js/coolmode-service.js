...
export const CoolModeService = {
    start(env, {}) {
        const defaultParticle = "circle";
        const particleType = defaultParticle;
        ...
        function loop() {
            ...
            refreshParticles();
            animationFrame = autoAddParticle || particles.length ? requestAnimationFrame(loop) : undefined;
        }
        ...
        document.addEventListener(tap, tapHandler, { passive: true });
    },
};

registry.category('services').add('ivik_coolmode', CoolModeService);
